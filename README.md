...
XLSwiftKit is a library to .......

<!-- <img src="Example/XLSwiftKit.gif" width="300"/> -->
...
* If you **found a bug** or **need help** please **check older issues, [FAQ](#faq) and threads on [StackOverflow](http://stackoverflow.com/questions/tagged/XLSwiftKit) (Tag 'XLSwiftKit') before submitting an issue.**.
...
You can also experiment and learn with the *XLSwiftKit Playground* which is contained in *XLSwiftKit.workspace*.
